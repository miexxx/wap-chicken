    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::recharge.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="money" name="money"  class="form-control name" placeholder="输入 充值金额">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" id="free" name="free"  class="form-control name" placeholder="输入 赠送金额">
                                    </div>
                                </div>
                            </div>
