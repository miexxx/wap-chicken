                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group" style="width: 100%">
                                    ...
                                    <input type="hidden" id="target" name="target" value="{{ $banner->target_2 }}" class="form-control target" placeholder="输入 目标">
                                    <input type="text" id="faker_target" name="faker_target"  @if($banner->type == 'goods') value="您所选择的商品为 : {{ $title->title }}" @else value=" {{ $banner->target_2 }}" @endif class="form-control target" placeholder="输入 目标">
                            </div>
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    $(items).each(function (index,value) {
                        html1 +=  "<tr val_id='"+value['id']+"' class='item-tr' style=\"cursor: pointer;\">";
