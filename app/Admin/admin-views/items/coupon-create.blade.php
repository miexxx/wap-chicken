    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::coupons.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="fields-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="money" name="money" value="" class="form-control name" placeholder="输入 优惠卷金额">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" id="base_money" name="base_money" value="" class="form-control name" placeholder="输入门槛金额">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="time" name="time" value="" class="form-control name" placeholder="输入天数">
