                    ...
                    <div class="box-body">
                        <div class="fields-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control category" style="width: 100%;" name="category_id" data-placeholder="选择 分类"  >
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" >{{ $category->name }}@if($category->type==1)(套餐分类)@endif</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control category" style="width: 100%;" name="item_type" data-placeholder="选择 类型"  >
                                        <option value="">请选择</option>
                                        <option value="0" >其他商品</option>
                                        <option value="1">母鸡商品</option>
                                        <option value="2"  >黄壳蛋商品</option>
                                        <option value="3" >绿壳蛋商品</option>
                                        <option value="4"  >公鸡商品</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="unit_price" name="unit_price" value="0" class="form-control unit_price" placeholder="输入 套餐商品价">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <textarea name="parameter" id="details1" cols="30" rows="10" hidden></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <textarea name="packaging" id="details2" cols="30" rows="10" hidden></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="checkbox" class="is_extension la_checkbox" checked/>
